...
?>		
  ...
  </table><br><button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#empform">Add/Update Hours</button>
<!-- Modal EMP UPDATE -->
...
jQuery('#add_emp').on('click',function(){
	...
	jQuery.ajax({
            ...
            data:{empname:empname,emprate:emprate,month:month,action:'addhours'},
            type: "POST",
